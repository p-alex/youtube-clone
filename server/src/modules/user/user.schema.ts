...
export const ReTokenSchema = z.string({
...
export type GetProfileInfoInput = z.TypeOf<
  typeof getProfileInfoSchema
>["params"];
...
export type ForgetPasswordInput = z.TypeOf<
  typeof forgetPasswordSendCodeSchema
>["body"];

export type SearchChannelsInput = z.TypeOf<
  typeof searchChannelsSchema
>["query"];
